...
export default function App() {
  ...
  const [spType,setSpType]        = useState("appliance"); // which SP type the Engineers page side nav has selected
  ...
  useEffect(()=>{ if(currentUser){ loadEngineers(); loadStaffUsers(); loadBookings(); loadPlans(); if(currentUser.role==="owner") loadPricing(); } },[currentUser]);
  ...
  const saveJob=async (form)=>{
    if(editJob){
      ...
      if(justFinished) await loadEngineers();
    } else {
