          ...
          {shown.map((sp,i)=>(
            <div key={sp.id} style={{padding:"12px 18px",borderBottom:i<shown.length-1?`1px solid ${C.border}`:"none",display:"flex",alignItems:"center",gap:12,flexWrap:"wrap"}}>
              ...
              <div style={{flex:1,minWidth:120}}>
                ...
                <div style={{color:C.light,fontSize:11}}>{sp.phone} · {sp.email}</div>
            ...
            <div key={sp.id} style={{background:C.card,borderRadius:13,boxShadow:"0 1px 3px rgba(0,0,0,.05)",overflow:"hidden"}}>
              <div style={{padding:"13px 15px",borderBottom:`1px solid ${C.border}`,display:"flex",gap:10,alignItems:"center",flexWrap:"wrap"}}>
                ...
                <div style={{flex:1,minWidth:120}}>
                  ...
                  <div style={{color:C.light,fontSize:11}}>{[sp.company,sp.phone,sp.email].filter(Boolean).join(" · ")||"No contact details"}</div>
                </div>
                ...
                {shown.map(eng=>{
                  ...
                  return (
                    <div key={eng.id} style={{background:C.card,borderRadius:13,boxShadow:"0 1px 3px rgba(0,0,0,.05)",overflow:"hidden"}}>
                      <div style={{padding:"13px 15px",borderBottom:`1px solid ${C.border}`,display:"flex",gap:10,alignItems:"center",flexWrap:"wrap"}}>
                        <Av initials={eng.name.split(" ").map(w=>w[0]).join("")} color={accent}/>
                        <div style={{flex:1,minWidth:120}}><div style={{fontWeight:800,fontSize:14,display:"flex",alignItems:"center",gap:6}}>{eng.name}{eng.isTest&&<TestPill/>}</div><div style={{color:C.light,fontSize:11}}>{eng.phone} · {eng.email}</div></div>
