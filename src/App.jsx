                ...
                <table style={{width:"100%",borderCollapse:"collapse",minWidth:820}}>
                  ...
                  <tbody>
                    {filtPlans.length===0?<tr><td colSpan={8} style={{padding:28,textAlign:"center",color:C.light}}>No {planStatusTab==="active"?"active":"cancelled"} protection plans{planSearch?" match that search":""}.</td></tr>:filtPlans.map(p=>{
                      ...
                      return <tr key={p.id} style={{borderBottom:"1px solid #262626"}} onMouseOver={e=>e.currentTarget.style.background="#1E2530"} onMouseOut={e=>e.currentTarget.style.background="transparent"}>
                        ...
                        <td style={{padding:"9px 13px",fontSize:12}}>{linkedJob?<button onClick={()=>setSelJob(linkedJob)} style={{background:"none",border:"none",color:C.primary,fontWeight:800,cursor:"pointer",fontFamily:"inherit",padding:0,fontSize:12}}>{linkedJob.bookingRef||('#'+linkedJob.id)}</button>:<span style={{color:C.light}}>—</span>}</td>
