  ...
  return (
    <div>
      ...
      <div style={{background:C.primaryLight,border:`1px solid #BFDBFE`,borderRadius:9,padding:"10px 16px",marginBottom:14,display:"flex",gap:24,flexWrap:"wrap",alignItems:"center"}}>
        {[["Appliance",job.appliance],["Brand",job.brand||"Unknown"],["Age",job.applianceAge?`${job.applianceAge} yr${job.applianceAge!=1?"s":""}` :"Unknown"],["Booked",fmtDateTime(job.createdAt)],["Source",job.source]].map(([l,v])=>(
